...
claude -p "$(cat <<'PROMPT'
你在 CyberCycho 独立游戏新闻静态站的仓库根目录（GitHub Pages 站点 https://hc-gamer.github.io/CyberCycho/ ，远程 HC-Gamer/CyberCycho，main 分支）。执行每日内容更新，今天日期用 date 命令确认：
...
5. 轮询 gh api repos/HC-Gamer/CyberCycho/pages/builds/latest 直到 status 为 built，再 curl 线上首页确认 200 且包含新条目关键词。
